...
myConf = {TransitionF, InputF, OutputF, MemoryF, StatesF, InitialF, AcceptanceConditionF, InfiniteF, ShapeF, ProbabilityF, HierarchicalF}

myVariationalMetamodel = VariationalMetamodel(features,autopl,featModelConstraints)

prod_mm = myVariationalMetamodel.derive(myConf)

# pretty_print_package(prod_mm)


def atLeast2ClassesWithAtLeast3Refs(mm : Metamodel):
    count = 0
    for c in mm.classes: 
...
# print(atLeast2ClassesWithAtLeast3Refs(prod_mm))

myExampleAnalysis = AnalysisInstance(myVariationalMetamodel, atLeast2ClassesWithAtLeast4Fields)

# s = Solver()
# print(count_models(s,features, featModelConstraints))
# print(checkSatWith(s,And(myVariationalMetamodel.upward(prod_mm),myVariationalMetamodel.downward(prod_mm))))

# print(myVariationalMetamodel.upward(prod_mm))
# print(myVariationalMetamodel.downward(prod_mm))
# print(checkSatWith(s,myVariationalMetamodel.downward(prod_mm)))
# print(myVariationalMetamodel.featModel)
